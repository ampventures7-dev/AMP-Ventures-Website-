      ...
      <section className="py-16 sm:py-20 bg-white border-t border-slate-200/80">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-6 sm:p-7 rounded-2xl bg-white border border-slate-200 shadow-xs hover:shadow-md hover:border-slate-300 transition-all flex flex-col justify-between">
              <div className="mb-5">
                <div className="mb-2.5">
                  <span className="px-2.5 py-1 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200 font-bold text-xs">Feature 01</span>
                </div>
              ...
              <div className="p-3.5 sm:p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2 font-sans">
                <div className="flex items-start gap-2">
                  <div className="w-5 h-5 rounded-full bg-slate-200 flex items-center justify-center text-[10px] font-bold text-slate-700 flex-shrink-0">U</div>
                  <div className="px-3 py-1.5 rounded-lg rounded-tl-none bg-white text-slate-800 border border-slate-200 text-xs leading-normal shadow-2xs">
            ...
            <div className="p-6 sm:p-7 rounded-2xl bg-white border border-slate-200 shadow-xs hover:shadow-md hover:border-slate-300 transition-all flex flex-col justify-between">
              <div className="mb-5">
                <div className="mb-2.5">
                  <span className="px-2.5 py-1 rounded-full bg-sky-50 text-sky-700 border border-sky-200 font-bold text-xs">Feature 02</span>
                </div>
              ...
              <div className="p-3.5 sm:p-4 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-[11px] sm:text-xs text-emerald-700 font-semibold mt-0.5">Rank #1 on Google Maps</div>
                  </div>
                </div>
                <div className="text-base sm:text-lg font-extrabold text-amber-600 font-mono">4.9 ★</div>
              </div>
            </div>
            ...
            <div className="p-6 sm:p-7 rounded-2xl bg-white border border-slate-200 shadow-xs hover:shadow-md hover:border-slate-300 transition-all flex flex-col justify-between">
              <div className="mb-5">
                <div className="mb-2.5">
                  <span className="px-2.5 py-1 rounded-full bg-indigo-50 text-indigo-700 border border-indigo-200 font-bold text-xs">Feature 03</span>
                </div>
              ...
              <div className="p-3.5 sm:p-4 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-[11px] sm:text-xs text-slate-500 font-medium mt-0.5">Pay only for basic domain & server</div>
                  </div>
                </div>
                <span className="text-xs font-mono px-2.5 py-1 rounded-md bg-indigo-50 text-indigo-700 border border-indigo-200 font-bold">Zero Lock-In</span>
              </div>
            </div>
            ...
            <div className="p-6 sm:p-7 rounded-2xl bg-white border border-slate-200 shadow-xs hover:shadow-md hover:border-slate-300 transition-all flex flex-col justify-between">
              <div className="mb-5">
                <div className="mb-2.5">
                  <span className="px-2.5 py-1 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200 font-bold text-xs">Feature 04</span>
                </div>
              ...
              <div className="p-3.5 sm:p-4 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-around text-center">
                <div>
                  <div className="text-sm sm:text-base font-bold text-emerald-600 font-mono leading-tight">&lt; 0.4s</div>
                  <div className="text-[11px] text-slate-500 font-medium mt-0.5">Load Time</div>
                </div>
                <div className="h-6 w-px bg-slate-200" />
                <div>
                  <div className="text-sm sm:text-base font-bold text-sky-600 font-mono leading-tight">100/100</div>
                  <div className="text-[11px] text-slate-500 font-medium mt-0.5">SEO Score</div>
                </div>
                <div className="h-6 w-px bg-slate-200" />
                <div>
                  <div className="text-sm sm:text-base font-bold text-emerald-600 font-mono leading-tight">99.9%</div>
                  <div className="text-[11px] text-slate-500 font-medium mt-0.5">Uptime SLA</div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-slate-50/50 border-t border-slate-200/80">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="mobile-snap-carousel lg:grid lg:grid-cols-3 gap-6 lg:gap-8 items-stretch no-scrollbar">
            ...
            {/* Tier 2 (Featured) */}
            <div className="mobile-snap-card p-6 sm:p-8 rounded-2xl bg-white border-2 border-sky-500 shadow-xl shadow-sky-500/10 flex flex-col justify-between relative transform lg:-translate-y-2">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-0.5 rounded-full bg-sky-500 text-white text-[9px] sm:text-[10px] font-extrabold uppercase tracking-wider shadow-md whitespace-nowrap">
              ...
              <Link to="/contact?tier=tier2" className="w-full py-2.5 sm:py-3 rounded-xl bg-sky-500 hover:bg-sky-600 text-white text-xs font-bold text-center shadow-md shadow-sky-500/25 transition-all">
                Get Tier 2 Quote
              </Link>
            </div>
